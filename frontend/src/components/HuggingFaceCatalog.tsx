    ...
    <div className="space-y-4 font-sans">
      ...
      >
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white text-xs font-bold flex items-center gap-1.5 transition-colors shadow-xs shrink-0"
        >
          {isLoading ? (
      ...
      {isLoading ? (
        ...
        <div className="py-16 text-center text-zinc-400 text-xs bg-white rounded-2xl border border-zinc-200 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
          {results.map((hfModel) => {
            ...
            return (
              <div
                key={hfModel.id}
                className={`p-4 rounded-2xl border transition-all flex flex-col justify-between bg-white shadow-xs ${
                  isCurrentlyServing
                    ? 'border-emerald-500/80 ring-1 ring-emerald-500/20 bg-emerald-50/10'
                    : isCardStaged
                ...
                <div className="space-y-2">
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      <h5 className="font-bold text-xs text-zinc-900 truncate" title={hfModel.name}>
                        {hfModel.name}
                      </h5>
                    ...
                    <div className="flex items-center space-x-2 text-[10px] text-zinc-500 font-mono shrink-0">
                  ...
                  <div className="flex items-center justify-between text-[10px] text-zinc-400">
                    <span className="font-mono bg-zinc-100 px-1.5 py-0.5 rounded border border-zinc-200/80 text-zinc-600">
                    ...
                    <a
                      ...
                      className="text-indigo-600 hover:text-indigo-700 flex items-center gap-0.5 hover:underline"
                    >
                      <span>HF Hub</span>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {isCurrentlyServing ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-zinc-900 hover:bg-indigo-600 disabled:opacity-40 text-white text-xs font-semibold transition-colors shadow-2xs cursor-pointer"
                        >
