...
import { CodeProps, ElementProps } from './markdownProps';
...
function buildComponents(
  ...
  return {
    ...
    em: ({ children, ...props }: ElementProps<'em'>) => (
      <em className={`italic ${body}`} {...props}>
        {children}
      </em>
    ),
    a: ({ children, href, ...props }: ElementProps<'a'>) => (
      <a
    ...
    hr: (props: ElementProps<'hr'>) => <hr className="my-5 border-md-outline-variant" {...props} />,
    blockquote: ({ children, ...props }: ElementProps<'blockquote'>) => (
      <blockquote
    ...
    table: ({ children, ...props }: ElementProps<'table'>) => (
    ...
    th: ({ children, ...props }: ElementProps<'th'>) => (
      <th
